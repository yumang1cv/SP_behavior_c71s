...
if __name__ == '__main__':
    # file_list = open_data(
    #     'D:/3D_behavior/Spontaneous_behavior/result_fang/inf_add_results/BeAMapping/',
    #     'Feature_Space.csv')
...
# """
#     fang-Spontaneous Shank3B HE Behavior Class Combine
#     1、Flight:[]                     2、Running:[12,11,28]                    3、Trotting:[3,40,4]
#     4、Walking:[26,15,27,16]         5、Stepping:[37,30,29]                   6、Left turning:[7,8,13]
#     7、Right turning:[1,5,6]         8、Sniffing:[2,14,23,24,25,35,38,19]    9、Grooming:[17,18,32]
#     10、Rearing:[33,39]              11、Hunching:[31]
#     12、Rising:[20,22,36]                             13、Climbing up:[9,10,34]
#
# """
# # class_label_dict = {1: [ ] , 2: [12,11,28], 3: [3,40,4], 4: [26,15,27,16]  , 5: [37,30,29] , 6: [7,8,13],
# #                     7: [1,5,6], 8: [2,14,23,24,25,35,38,19], 9: [17,18,32], 10: [33,39]   , 11: [31],
# #                     12: [20,22,36] , 13: [9,10,34]}
# #
# # new_dict = {}
# # for index, key in enumerate(class_label_dict):
# #     for item in class_label_dict[key]:
...
#
#
# class_label_dict = {12: 2, 11: 2, 28: 2, 3: 3, 40: 3, 4: 3, 26: 4, 15: 4, 27: 4, 16: 4, 37: 5, 30: 5, 29: 5, 7: 6,
#                     8: 6, 13: 6, 1: 7, 5: 7, 6: 7, 2: 8, 14: 8, 23: 8, 24: 8, 25: 8, 35: 8, 38: 8, 19: 8, 17: 9,
#                     18: 9, 32: 9, 33: 10, 39: 10, 31: 11, 20: 12, 22: 12, 36: 12, 9: 13, 10: 13, 34: 13, 21: 1}
#
#
# def open_data(data_path, file_type):
#     file_list = []
...
# if __name__ == '__main__':
#     # file_list = open_data(
#     #     'K:/Shank3B-square-SP-Looming-result/Sp-Looming-HE/Result/BeAMapping_replace/',
#     #     'Feature_Space.csv')
#     file_list = open_data('K:/Shank3B-square-SP-Looming-result/Sp-Looming-HE/Result/BeAMapping_replace/',
#                           'Movement_Labels.csv')
#     # file_list = sorted(file_list, key=int)   # sort file use num
#     for i in tqdm(range(0, len(file_list))):
#         with open(file_list[i], 'rb') as file:
