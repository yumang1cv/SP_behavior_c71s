# -*- coding:utf-8 -*-
# @FileName  :SP_behavior_state_convert_annoMV.py
...
movement_names = list(movement_index.keys())
...
def pre_data(file_path, start_index):
    ...
    data = df2.iloc[(start_index-1)*18000+1:start_index*18000, 5:6]
...
if __name__ == '__main__':
    ...
    for i in range(1, 2):
        ...
        #     "/{}time_{}0~{}0min.tiff".format(ExperimentTime, i - 1, i), transparent=True, dpi=300)
        ...
        # ax = sns.heatmap(A, yticklabels=False, xticklabels=False, cmap="vlag", annot=True, linewidths=.5)
