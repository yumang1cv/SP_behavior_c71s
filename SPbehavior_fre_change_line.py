...
male_day = pd.read_csv(r'D:/3D_behavior/Spontaneous_behavior/result/analysis_result/state_convert/v2/behavior_freline'
                       r'/1min/maleday_1min.csv')
male_night = pd.read_csv(r'D:/3D_behavior/Spontaneous_behavior/result/analysis_result/state_convert/v2'
                         r'/behavior_freline/1min/malenight_1min.csv')
female_day = pd.read_csv(r'D:/3D_behavior/Spontaneous_behavior/result/analysis_result/state_convert/v2'
                         r'/behavior_freline/1min/femaleday_1min.csv')
female_night = pd.read_csv(r'D:/3D_behavior/Spontaneous_behavior/result/analysis_result/state_convert/v2'
                           r'/behavior_freline/1min/femalenight_1min.csv')
...
for label in range(len(names)):
    ...
    time = [i for i in range(1, 61, 1)] * 1
