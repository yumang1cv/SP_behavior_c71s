...
if __name__ == '__main__':
    ...
    for i in range(0, 60, 5):
        Male_list = pre_data(file_list_1, i, i + 5)
    ...
    # male_all.to_excel('E:/Shank3B-square-SP-Looming-result/{}_{}_5min.xlsx'.format(gender, group))
    # female_all.to_excel('E:/Shank3B-square-SP-Looming-result/female_{}_5min.xlsx'.format(group))
