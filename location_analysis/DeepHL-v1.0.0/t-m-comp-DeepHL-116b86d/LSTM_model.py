...
from tensorflow.keras.layers import Input, LSTM, Dense, Dropout, Activation, TimeDistributed, Flatten, Masking, Embedding, Conv1D, RepeatVector, Permute, Lambda
# from keras.layers import normalization, merge
